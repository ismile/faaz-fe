...
const FDataTableFilter = ({useStore}) => {
  ...
  return (
    ...
    >
      ...
      >
        <Box sx={{ flex: 1 }}>
          <ColumnSort useStore={useStore} />
          <Divider />
          <ColumnFilter useStore={useStore} />
        </Box>
        <div>
          <ColumnSelector useStore={useStore} />
        </div>
      </SwipeableViews>
          ...
          return (
            <ListItem key={d.key}>
              ...
              <ListItemSecondaryAction>
                <SwitchTable useStore={useStore} dataKey={d.key} hidden={d.hidden} />
              </ListItemSecondaryAction>
            </ListItem>
          )
        })}
...
export default FDataTableFilter
